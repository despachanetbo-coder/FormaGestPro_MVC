...
class DocentesTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.tabla_docentes.verticalHeader().setVisible(False)  # Ocultar números de fila
        self.tabla_docentes.verticalHeader().setDefaultSectionSize(40)  # Altura uniforme de filas
    ...
    def filtrar_docentes(self, desde_paginacion=False):
            ...
            try:
                ...
                print(f"Método filtrar_docente docentes_filtrados_actuales={self.docentes_filtrados_actuales}")
    ...
    def mostrar_docentes_en_tabla(self, docentes):
        ...
        try:
            ...
            columnas = [
                "ID", "# Carnet", "Nombre Docente", "Especialidad",
                "Email", "Teléfono", "CV", "Estado", "Acciones"
            ]
            ...
            for fila, docente in enumerate(docentes):
                ...
                btn_pdf.clicked.connect(lambda checked, d=docente: self.ver_cv_docente(d))
                ...
                btn_estado.clicked.connect(lambda checked, d=docente: self.toggle_estado_docente(d))
                ...
                """)
                btn_eliminar.clicked.connect(lambda checked, d=docente: self.eliminar_docente(d))
            ...
            self.tabla_docentes.setColumnWidth(2, 250)     # Nombre Docente (ancho suficiente para grado + nombres)
            ...
            self.tabla_docentes.setColumnWidth(8, 225)     # Acciones (espacio para 5 botones)

            # Hacer que algunas columnas sean expansibles
            self.tabla_docentes.horizontalHeader().setSectionResizeMode(2, QHeaderView.Stretch)  # Nombre Docente
            self.tabla_docentes.horizontalHeader().setSectionResizeMode(3, QHeaderView.Stretch)  # Especialidad
            self.tabla_docentes.horizontalHeader().setSectionResizeMode(4, QHeaderView.Stretch)  # Email
    ...
    def ver_cv_docente(self, docente):
        ...
        try:
            ...
            if cv_path:
                ...
                QMessageBox.information(self, "Sin CV", 
                                      "Este docente no tiene un CV cargado.")
        ...
        try:
            ...
            if respuesta == QMessageBox.Yes:
                ...
                QMessageBox.information(self, "✅ Éxito", 
                                      f"Docente {estado_final} correctamente")
    ...
    def eliminar_docente(self, docente):
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", 
                               f"Error al eliminar docente: {str(e)}")
    ...
    def calcular_paginacion(self, docentes_filtrados):
        ...
        self.total_pages = max(1, (total_docentes + self.records_per_page - 1) // self.records_per_page)
    ...
    def mostrar_pagina_actual(self):
        ...
        total_docentes, start_idx, end_idx = self.calcular_paginacion(self.docentes_filtrados_actuales)

        # Mostrar docentes de la página actual
        self.mostrar_docentes_en_tabla(self.docentes_paginados)

        # Actualizar contador
        mostrar_texto = f"Mostrando {len(self.docentes_paginados)} de {total_docentes} registros"
        if total_docentes > 0:
