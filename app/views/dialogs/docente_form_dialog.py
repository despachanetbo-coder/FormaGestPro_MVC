...
class DocenteFormDialog(QDialog):
    ...
    def __init__(
        self, docente_id=None, docente_data=None, modo_lectura=False, parent=None
    ):
        """
    ...
    def _crear_panel_cv(self):
        ...
        card_container.setMinimumHeight(
            480
        )  # Más alto para acomodar la vista previa proporcional
        ...
        preview_frame.setFixedSize(
            preview_width + 20, preview_height + 20
        )  # +20 para el padding/borde
        ...
        self.lbl_info_cv.setTextInteractionFlags(
    ...
    def _agregar_botones_cv(self, layout):
        ...
        self.btn_abrir_cv.setToolTip(
            "Abrir el PDF completo con el visor predeterminado"
        )
    ...
    def cargar_datos(self):
        ...
        try:
            ...
            self.txt_especialidad.setText(
                str(self.docente_data.get("especialidad", ""))
            )
            self.txt_grado_academico.setText(
                str(self.docente_data.get("grado_academico", ""))
            )
        ...
        try:
            ...
            if docente:
                ...
                dialog = DocenteFormDialog(
                    docente_data=datos, modo_lectura=True, parent=self.parent()
                )
                dialog.exec()
        ...
        try:
            ...
            if self.ruta_cv_original:
                ...
                if (
                    ...
                    and self.directorio_cvs in ruta_path.parents
                ):
                    try:
                        ruta_path.unlink()
                    except Exception as e:
        ...
        try:
            ...
            if self.ruta_cv_original:
                ...
                if (
                    ...
                    and self.directorio_cvs in ruta_anterior.parents
                ):
                    try:
    ...
    def on_inscribir_clicked(self):
        ...
        try:
            print(
                f"DEBUG: Botón Asignar Cursos clickeado para docente ID {self.docente_data.get('id')}"
            )
            ...
            QMessageBox.warning(
                self, "Error", f"Error al procesar asignación: {str(e)}"
            )
    ...
    def on_editar_clicked(self):
        ...
        try:
            print(
                f"DEBUG: Botón Editar clickeado para docente ID {self.docente_data.get('id')}"
            )
    ...
    def on_borrar_clicked(self):
        ...
        try:
            ...
            if respuesta == QMessageBox.Yes:
                print(
                    f"DEBUG: Confirmada eliminación de docente ID {self.docente_data.get('id')}"
                )
    ...
    def generar_vista_previa_pdf(self, ruta_pdf):
        ...
        try:
            ...
            qimage_escalada = qimage.scaled(
                240,
                240,  # Un poco más pequeño que el label
                Qt.KeepAspectRatio,
