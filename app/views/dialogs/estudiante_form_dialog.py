...
from PySide6.QtWidgets import (
    ...
    QGroupBox, QRadioButton, QButtonGroup, QSpinBox, QDoubleSpinBox,
    QSizePolicy, QFrame, QWidget, QScrollArea
)
...
class EstudianteFormDialog(QDialog):
    ...
    def __init__(self, estudiante_id=None, estudiante_data=None, modo_lectura=False, parent=None):
        """
    ...
    def _crear_seccion_estado(self):
        ...
        esta_activo = self.estudiante_data.get('activo', 1) if self.estudiante_data else 1
    ...
    def _agregar_botones_foto(self, layout):
        ...
        """)
        self.btn_seleccionar_foto.setToolTip("Seleccionar imagen JPG/JPEG del estudiante")
    ...
    def _crear_area_botones(self):
        ...
        # Botones para modo lectura
            ...
            self.btn_inscribir = self._crear_boton("🎓 Inscribir", "#9b59b6", "#8e44ad", "#7d3c98")
            self.btn_editar = self._crear_boton("✏️ Editar", "#27ae60", "#219653", "#1e8449")
            self.btn_borrar = self._crear_boton("🗑️ Eliminar Estudiante", "#e74c3c", "#c0392b", "#a93226", es_principal=True)
            self.btn_cerrar = self._crear_boton("✖️ Cerrar Vista", "#e74c3c", "#c0392b", "#a93226", es_principal=True)
            
            self.btn_inscribir.setToolTip("Matricular este estudiante en un programa académico")
    ...
    def cargar_datos(self):
        ...
        try:
            ...
            self.txt_universidad.setText(str(self.estudiante_data.get('universidad_egreso', '')))
        ...
        try:
            ...
            if estudiante:
                ...
                if hasattr(self.parent(), 'on_editar_desde_modo_lectura'):
                    dialog.estudiante_editar.connect(self.parent().on_editar_desde_modo_lectura)
        ...
        try:
            ...
            if self.ruta_foto_original:
                ...
                if (ruta_path.exists() and 
                    ...
                    self.directorio_fotos in ruta_path.parents):
                    try:
                        ruta_path.unlink()
                    except Exception as e:
        ...
        try:
            ...
            if self.ruta_foto_original:
                ...
                if (ruta_anterior.exists() and 
                    ...
                    self.directorio_fotos in ruta_anterior.parents):
                    try:
    ...
    def set_readonly_mode(self, readonly=True):
        ...
        widgets = [
            ...
            self.txt_apellidos, self.date_nacimiento, self.txt_telefono,
            self.txt_email, self.txt_universidad, self.txt_profesion,
        ]
