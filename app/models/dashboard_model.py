...
class DashboardModel:
    ...
    def insert_sample_data(self):
        ...
        # Insertar docentes
        docentes = [
            ('Carlos', 'Ruiz', 'V-12345678', 'Informática', 'carlos.ruiz@example.com', '0412-1111111'),
            ('Ana', 'López', 'V-87654321', 'Administración', 'ana.lopez@example.com', '0412-2222222'),
            ('Pedro', 'Martínez', 'V-11223344', 'Contabilidad', 'pedro.martinez@example.com', '0412-3333333'),
            ('María', 'García', 'V-44332211', 'Derecho', 'maria.garcia@example.com', '0412-4444444'),
        ]
