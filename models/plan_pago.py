# models/plan_pago.py
"""
Modelo de Plan de Pago usando SQLite3 directamente.
"""
import logging
...
class PlanPagoModel(BaseModel):
    ...
    @classmethod
    def crear_plan_pago(cls, programa_id: int, nombre: str, nro_cuotas: int, 
                       intervalo_dias: int, descripcion: str = None) -> 'PlanPagoModel':
        ...
        if existente:
            raise ValueError(f"Ya existe un plan de pago con el nombre '{nombre}' para este programa")
    ...
    @classmethod
    def crear_para_programa(cls, programa_id, nombre, nro_cuotas, monto_cuota=None, 
                           intervalo_dias=30, fecha_inicio=None):
