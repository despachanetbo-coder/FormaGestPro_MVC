...
class ProgramaModel(BaseModel):
    ...
    # En models/programa.py, añade este método a la clase ProgramaModel:
    @classmethod
    ...
    @classmethod
    def crear_programa(cls, datos: Dict) -> 'ProgramaModel':
    ...
    @classmethod
    def buscar_por_codigo(cls, codigo: str) -> Optional['ProgramaModel']:
    ...
    @classmethod
    def buscar_por_estado(cls, estado: str) -> List['ProgramaModel']:
    ...
    @classmethod
    def buscar_por_tutor(cls, tutor_id: int) -> List['ProgramaModel']:
    ...
    @classmethod
    def buscar_con_cupos_disponibles(cls) -> List['ProgramaModel']:
    ...
    @classmethod
    def buscar_promociones_activas(cls) -> List['ProgramaModel']:
